...
/**
 * An EasyApplyIndeedBot is an IndeedBot, except with a function to find easy apply
 * jobs.
 * 
 * @author Bruce Tieu
 *
 */
public class EasyApplyIndeedBot extends IndeedBot {
     ...
     */
    public EasyApplyIndeedBot(JobApplicationData jobAppData, ApplicationType appType, WriteFiles writeFiles) {
